        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Tambah Merek</a></li>
                </ol>
            </div>
        </div>
        <!-- row -->
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            <form action="/merek/add_merek" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                                ...
                                <div class="form-group row mt-4">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group m-2 text-center">
                                            <input type="file" name="cover_merek" placeholder="Choose image" id="image">
                                            @error('image')
