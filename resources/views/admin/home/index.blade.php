                ...
                <div class="card">
                    <div class="stat-widget-one card-body">
                        ...
                        <div class="stat-content d-inline-block">
                            ...
                            <div class="stat-digit">{{$kategori->count()}}</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="stat-widget-one card-body">
                        ...
                        <div class="stat-content d-inline-block">
                            ...
                            <div class="stat-digit">{{$user->where('level','customer')->count()}}</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="stat-widget-one card-body">
                        ...
                        <div class="stat-content d-inline-block">
                            ...
                            <div class="stat-digit">{{$produk->count()}}</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6">
                <div class="card">
                    <div class="stat-widget-one card-body">
                        ...
                        <div class="stat-content d-inline-block">
                            <div class="stat-text">Promo</div>
                            <div class="stat-digit">{{$promo->count()}}</div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="recent-comment m-t-15">
                            <div class="media">
                                <div class="media-left">
                                    <a href="#"><img class="media-object mr-3"
                                            src="{{asset('assets_admin/images/avatar/4.png')}}" alt="..."></a>
                                </div>
                            ...
                            <div class="media">
                                <div class="media-left">
                                    <a href="#"><img class="media-object mr-3"
                                            src="{{asset('assets_admin/images/avatar/2.png')}}" alt="..."></a>
                                </div>
                                <div class="media-body">
                            ...
                            <div class="media">
                                <div class="media-left">
                                    <a href="#"><img class="media-object mr-3"
                                            src="{{asset('assets_admin/images/avatar/3.png')}}" alt="..."></a>
                                </div>
                                <div class="media-body">
